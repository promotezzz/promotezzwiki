      ...
      <div className="relative z-10 max-w-xl mx-auto px-4 sm:px-6 py-20 sm:py-28 w-full flex-1">
        ...
        <div className="space-y-4">
          {mods.map((mod) => (
            ...
            >
              <div className="mb-2">
                <h2 className="text-xl font-bold text-neutral-900 group-hover:text-purple-600 transition-colors">
                  {mod.title}
                </h2>
              </div>
              ...
              <div className="flex items-center gap-1.5 text-xs font-semibold text-purple-600 group-hover:text-purple-700">
